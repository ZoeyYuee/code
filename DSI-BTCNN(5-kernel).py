...
class BERT_TextCNN_BiLSTM(nn.Module):
    def __init__(self):
        ...
        self.conv4 = nn.Conv2d(in_channels=1, out_channels=HIDDEN_DIM, kernel_size=(9, EMBEDDING))
        self.conv5 = nn.Conv2d(in_channels=1, out_channels=HIDDEN_DIM, kernel_size=(11, EMBEDDING))
        ...
        self.cnn_linear = nn.Linear(HIDDEN_DIM * 5, HIDDEN_DIM)
    ...
    def forward(self, input_tensor, mask, hidden):
        ...
        cnn_out4 = self.conv_and_pool(self.conv4, bert_cnn_out)
        cnn_out5 = self.conv_and_pool(self.conv5, bert_cnn_out)
        ...
        cnn_out = torch.cat([cnn_out1, cnn_out2,cnn_out3,cnn_out4,cnn_out5], dim=1)
